...
export function BuildPaths(pathIn: string, tdb: string) {
    return generateTree(pathIn, dir({
        ...
        client_extensions: dirn('client-extensions',{
            dll_path_rel: file('ClientExtensions/Release/ClientExtensions.dll'),
            dll_path_deb: file('ClientExtensions/Debug/ClientExtensions.dll'),
            dll_path_rel_with_deb: file('ClientExtensions/RelWithDebInfo/ClientExtensions.dll')
        }),
        ...
        mysqlArchive: file('mysql-8.0.40-winx64.zip'),

...
export class AuraType extends EnumCellTransform<SpellEffect> {
    ...
    /** Enum Value:                                               119 */
    get MOD_HEALING_FROM_BANDAGE_PCT()        { return this.value(119, x=>new ModHealingFromBandagePct(x)) }
    /** Enum Value:                                               120 */

...
declare interface TSWorldObject extends TSObject, TSWorldEntityProvider<TSWorldObject> {
    ...
    IsValidAssistTarget(obj: TSWorldObject, spellInfo?: TSSpellInfo): bool
     ...
     */
      ...
      */
     CastCustomSpell(target : TSWorldObject | TSItem,spell : uint32,triggered? : bool,bp0? : int32,bp1? : int32,bp2? : int32, stacks? : uint8, dur? : uint32, castItem? : TSItem,originalCaster? : uint64) : SpellCastResult
